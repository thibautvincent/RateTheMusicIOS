...
class Album {
    ...
    init(albumtitle: String, artist: String, released_at: String, genre: String, cover: String, description: String, songs:[Song], upvotes:[Upvote], comments:[Comment]){
...
extension Album {
    convenience init(json: NSDictionary) throws {
        ...
        self.init(albumtitle: albumtitle, artist: artist, released_at: released_at, genre: genre, cover: cover, description: description, songs: songs, upvotes: upvotes, comments: comments)
    }
}